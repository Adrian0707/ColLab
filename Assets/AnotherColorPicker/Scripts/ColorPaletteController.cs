...
public class ColorPaletteController : MonoBehaviour, IBeginDragHandler, IDragHandler,IEndDragHandler, IInitializePotentialDragHandler
{
    ...
    public Transform wellLightTransform;
    public Transform pickedColorTransform;
    [SerializeField] SpriteRenderer pickedColorRenderer;
    ...
    [InspectorName("Control Sat & Val")] public bool controlSV = false;
    ...
    public void UpdateColor()
    {
        ...
        if(pickedColorRenderer) pickedColorRenderer.color = color;
        SelectedColor = color;
    ...
    public void OnDrag(PointerEventData eventData)
    {
        ...
        Hue += dtheta / 360;
        wellTransform.eulerAngles = new Vector3(wellTransform.rotation.x, wellTransform.rotation.y, wellTransform.rotation.z - 280*Hue);
        pickedColorTransform.eulerAngles = new Vector3(wellLightTransform.rotation.x, wellLightTransform.rotation.y, wellLightTransform.rotation.z - 580 * Hue);
        wellLightTransform.eulerAngles = new Vector3(wellLightTransform.rotation.x, wellLightTransform.rotation.y, wellLightTransform.rotation.z - 580 * Hue);
